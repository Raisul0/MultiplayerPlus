...
namespace MultiplayerPlusCommon.GameModes.FreeForAll
{
    public class MPPFreeForAllGameMode : MultiplayerGameMode
    {
        ...
        public MPPFreeForAllGameMode(string name) : base(name)
        {
