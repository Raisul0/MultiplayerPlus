...
{
    public class MPPEndOfRoundVM : ViewModel
    {
        ...
        public MPPEndOfRoundVM(MissionScoreboardComponent scoreboardComponent, MissionLobbyComponent missionLobbyComponent, IRoundComponent multiplayerRoundComponent)
        {
        ...
        public void ApplyCharacterCosmetics()
        {
            if (AttackerMVP != null)
            {
                SetMVPEquipment(AttackerMVP, EquipmentIndex.Head, AttackerEquipmentHead);
                SetMVPEquipment(AttackerMVP, EquipmentIndex.Cape, AttackerEquipmentShoulder);
                SetMVPEquipment(AttackerMVP, EquipmentIndex.Body, AttackerEquipmentBody);
                SetMVPEquipment(AttackerMVP, EquipmentIndex.Gloves, AttackerEquipmentArms);
                SetMVPEquipment(AttackerMVP, EquipmentIndex.Leg, AttackerEquipmentLegs);
                SetMVPEquipment(AttackerMVP, EquipmentIndex.Weapon0, AttackerWeapon0);
                SetMVPEquipment(AttackerMVP, EquipmentIndex.Weapon1, AttackerWeapon1);
                SetMVPEquipment(AttackerMVP, EquipmentIndex.Weapon2, AttackerWeapon2);
                SetMVPEquipment(AttackerMVP, EquipmentIndex.Weapon3, AttackerWeapon3);
                AttackerMVP.Preview.HeroVisual.ExecuteEquipWeaponAtIndex(EquipmentIndex.Weapon1,false);
            }

            if (DefenderMVP != null)
            {
                SetMVPEquipment(DefenderMVP, EquipmentIndex.Head, DefenderEquipmentHead);
                SetMVPEquipment(DefenderMVP, EquipmentIndex.Cape, DefenderEquipmentShoulder);
                SetMVPEquipment(DefenderMVP, EquipmentIndex.Body, DefenderEquipmentBody);
                SetMVPEquipment(DefenderMVP, EquipmentIndex.Gloves, DefenderEquipmentArms);
                SetMVPEquipment(DefenderMVP, EquipmentIndex.Leg, DefenderEquipmentLegs);
                SetMVPEquipment(DefenderMVP, EquipmentIndex.Weapon0, DefenderWeapon0);
                SetMVPEquipment(DefenderMVP, EquipmentIndex.Weapon1, DefenderWeapon1);
                SetMVPEquipment(DefenderMVP, EquipmentIndex.Weapon2, DefenderWeapon2);
                SetMVPEquipment(DefenderMVP, EquipmentIndex.Weapon3, DefenderWeapon3);
                DefenderMVP.Preview.HeroVisual.ExecuteEquipWeaponAtIndex(EquipmentIndex.Weapon1, false);
            }
        }

        private void SetMVPEquipment(MPPlayerVM mvpPlayer,EquipmentIndex equipmentIndex,string itemId)
        {
            if (mvpPlayer != null)
            {
        ...
        public void PlayCustomAnimation()
        {
            if (AttackerMVP != null)
            {
                AttackerMVP.Preview.HeroVisual.ExecuteStartCustomAnimation(AttackerMVPTaunt);
            }

            if (DefenderMVP != null)
            {
                DefenderMVP.Preview.HeroVisual.ExecuteStartCustomAnimation(DefenderMVPTaunt);
            }
        }
        ...
        public string AttackerMVPTaunt { get; set; }
        public string AttackerEquipmentHead { get; set; }
        public string AttackerEquipmentShoulder { get; set; }
        public string AttackerEquipmentBody { get; set; }
        public string AttackerEquipmentArms { get; set; }
        public string AttackerEquipmentLegs { get; set; }
        public string AttackerWeapon0 { get; set; }
        public string AttackerWeapon1 { get; set; }
        public string AttackerWeapon2 { get; set; }
        public string AttackerWeapon3 { get; set; }
        public string DefenderMVPTaunt { get; set; }
        public string DefenderEquipmentHead { get; set; }
        public string DefenderEquipmentShoulder { get; set; }
        public string DefenderEquipmentBody { get; set; }
        public string DefenderEquipmentArms { get; set; }
        public string DefenderEquipmentLegs { get; set; }
        public string DefenderWeapon0 { get; set; }
        public string DefenderWeapon1 { get; set; }
        public string DefenderWeapon2 { get; set; }
        public string DefenderWeapon3 { get; set; }
    }
}
